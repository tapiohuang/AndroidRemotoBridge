...
public final class ByteUtils {
    ...
    public static byte [] replaceAll(byte[] src,byte[] regexbt,byte[] replaceBt){
        String prefix = "";
        String suffix = ",";
        String str = ByteUtils.toHexString(src,prefix,suffix);
        String regex = ByteUtils.toHexString(regexbt,prefix,suffix);
        String replace = ByteUtils.toHexString(replaceBt,prefix,suffix);
        String afterReplace = str.replaceAll(regex,replace);
        afterReplace = afterReplace.replaceAll(suffix,"");
        return ByteUtils.parseHexStringToArray(afterReplace);
